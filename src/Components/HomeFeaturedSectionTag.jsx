...
const HomeFeaturedSectionTag = ({ label }) => (
    <div className="shadow-lg px-4 py-2.5 rounded-full shadow-indigo-100 flex items-center gap-2 w-fit">
      <svg
      ...
      <span className="font-monteserate font-light text-[1.2rem] inline-block">{label}</span>
    </div>
  );
