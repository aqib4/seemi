...
const HomeFeaturedSectionTag = ({ label }) => (
    <div className="shadow-lg p-2.5 rounded-full shadow-indigo-100 flex items-center gap-2 w-fit">
      <svg
      ...
      <span className="font-monteserate font-light text-sm inline-block">{label}</span>
    </div>
  );
